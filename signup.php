      ...
      <div class="container">
        <div class="signUpForm row">
          <div class="form-field col-lg-6">
            <input type="text" id="name" name="student_id" class="input-text" />
            <label for="name" class="label">Student ID</label>
          </div>
          <div class="form-field col-lg-6">
          ...
          <div class="form-field col-lg-6">
            <input type="password" id="name" name="password" class="input-text" />
          ...
          <div class="form-field col-lg-12">
            <input type="text" id="description" name="description" class="input-text" />
            <label for="Description" class="label">Description</label>
          </div>
        </div>
        <div class="form-field col-lg-12 text-center mt-4">
          <input type="submit" id="name" name="submit" value="Sign Up!"
            class="submit-btn btn btn-danger rounded-pill fs-6 text-uppercase" />
    </form>
    <div class="loginow mt-2">
      <a class="text-center link-dark text-decoration-none" href="login.html">
        you have an account ? Log In now</a>
    </div>
    </div>
    </div>
  </section>
